...
<div class="container">
    ...
    <div class="col-md-3">
        ...
        <div class="cleaner-h2"></div>
         ...
         <div class="buttoms">
           <ul>
           <li><a href="{{ url('articles/'.$next) }}" class="btn btn-prv">الخبر التالى</a></li>
           <li><a href="{{ url('articles/'.$previous) }}" class="btn btn-next">الخبر السابق</a></li>
