...
<div class="container">
    ...
    <div class="col-md-3">
            ...
            <ul class="right-colum">
                    ...
                    <li class="selected"><a href="{{ url('investment') }}"><i class="fa fa-arrow-left"></i>الفرص الإستثماريه</a></li>
        ...
        <div class="title">
        <h2 class="black">الفرص الاستثماريه</h2>
        ...
        @foreach ($investment as $one)
            <div class="news">
                    @if($one->image == "df.jpg")

                    @else
                    <img src="{{ url('Admin/images/investment_opportunity/'.$one->image)}}" class="img-responsive"/>
        ...
        <div class="cleaner-h2"></div>
         ...
         <div class="buttoms">
           <ul>
           <li><a href="{{ url('investment/'.$next) }}" class="btn btn-prv">الخبر التالى</a></li>
           <li><a href="{{ url('investment/'.$previous) }}" class="btn btn-next">الخبر السابق</a></li>
