...
<div class="container">
    ...
    <div class="col-md-3">
            ...
            <ul class="right-colum">
                    ...
                    <li class="selected"><a href="{{ url('challengs') }}"><i class="fa fa-arrow-left"></i>المنافسات</a></li>
            </ul>
        ...
        @foreach ($challengs as $one)
            <div class="news">
                    @if($one->image == "df.jpg")

                    @else
                        <img src="{{ url('Admin/images/challengs/'.$one->image)}}" class="img-responsive"/>
        ...
        <div class="cleaner-h2"></div>
         ...
         <div class="buttoms">
           <ul>
           <li><a href="{{ url('challengs/'.$next) }}" class="btn btn-prv">الخبر التالى</a></li>
           <li><a href="{{ url('challengs/'.$previous) }}" class="btn btn-next">الخبر السابق</a></li>
