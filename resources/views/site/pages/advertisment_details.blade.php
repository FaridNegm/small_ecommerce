...
<div class="container">
    ...
    <div class="col-md-3">
        ...
        <div class="title">
        <h2 class="black">إعلانات الأمانه</h2>
        ...
        @foreach ($advertisment as $one)
            <div class="news">
                    @if($one->image == "df.jpg")

                    @else
                        <img src="{{ url('Admin/images/advertisment/'.$one->image)}}" class="img-responsive"/>
                    @endif
                <h3>{{ $one->title }}</h3>
        ...
        <div class="cleaner-h2"></div>
         ...
         <div class="buttoms">
           <ul>
           <li><a href="{{ url('advertisment/'.$next) }}" class="btn btn-prv">الخبر التالى</a></li>
           <li><a href="{{ url('advertisment/'.$previous) }}" class="btn btn-next">الخبر السابق</a></li>
